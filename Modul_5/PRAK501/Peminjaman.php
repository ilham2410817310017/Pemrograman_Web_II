...
<body>
    ...
    <div class="container">
        ...
        <a href="FormPeminjaman.php" class="btn-tambah">+ Tambah Data Peminjaman</a>
                ...
                <?php if(!empty($peminjaman)): ?>
                    ...
                    <tr>
                        ...
                        <td class="action-buttons">
                            <a href="FormPeminjaman.php?id_edit=<?php echo $row['id_peminjaman']; ?>" class="btn-edit">Edit</a>
                            <a href="Peminjaman.php?id_hapus=<?php echo $row['id_peminjaman']; ?>" class="btn-hapus" onclick="return confirm('Yakin ingin menghapus data peminjaman ini?');">Hapus</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>
                        <td colspan="6" class="empty-data">Belum ada data peminjaman.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
